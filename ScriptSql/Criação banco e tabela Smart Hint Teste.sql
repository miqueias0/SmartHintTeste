...
CREATE TABLE `smart_hint`.cliente (
  ...
  `Isento` tinyint(1) DEFAULT NULL COMMENT 'Isento',
  ...
  `Senha` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Senha Criptografada ',
  `ClienteBloqueado` tinyint(1) DEFAULT '0' COMMENT 'Situação do Cliente',
  PRIMARY KEY (`Id`),
  UNIQUE KEY `cpf_cnpj_uk` (`CpfCnpj`)
)
ENGINE=InnoDB
